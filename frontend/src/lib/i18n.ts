...
const translations = {
  en: {
    ...
    'module.bank_reconciliation': '🏦 Bank Rec',
    'module.payroll_allocation':  '👥 Payroll',
  ...
  es: {
    ...
    'nav.bank_rec':     'Conc. Bancos',
    'nav.bookkeeping':  'Limpieza Contable',
    'nav.payroll':      'Nómina',
    ...
    'module.controller':          '📊 Controller',
    'module.bank_reconciliation': '🏦 Conc. Bancos',
    'module.payroll_allocation':  '👥 Nómina',
